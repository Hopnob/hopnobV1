            ...
            console.log("Height "+DeviceHeight+" Width "+DeviceWidth);
              return (
                <>
                    ...
                    {/* tabs */}
                    <View style={{paddingLeft:25,paddingRight:25, marginTop:30,flexDirection:'row',alignItems:'center', justifyContent:'space-around'}}>
                      ...
                      <Image style={{marginTop:16}} width={Dimensions.get('window').width} source={ require('../../assets/images/Introductory/banner1.png')} />
