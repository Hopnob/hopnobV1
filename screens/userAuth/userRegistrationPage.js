...
export default function UserRegisterPage({ navigation }) {
  ...
  const successAlert = () => {
    Alert.alert("User Created", "Welcome to Hopnob", [
      {
        text: "Next",
        ...
        >
          ...
          <View
            style={{
              ...
              paddingBottom: 30,
              width: wp("100%"),
              height: deviceHeight > 600 ? 440 : hp("50%"),
          ...
          >
            <View style={{ backgroundColor: "white" }}>
              ...
              <View
                style={{
                  width: deviceWidth > 375 ? 154 : wp("40%"),
              ...
              >
                <TouchableOpacity onPress={fbLoginHandler}>
                  <View
                    style={{
                      alignSelf: "center",
                      marginRight: 18,
                  ...
                  >
                    <Image
                      ...
                      source={require("../../assets/images/UserLogin/fb.png")}
                    />
                  </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity onPress={googleLoginHandler}>
                  ...
                  >
                    <Image
                      ...
                      source={require("../../assets/images/UserLogin/google.png")}
                    />
                  </View>
                </TouchableOpacity>

                <TouchableOpacity onPress={instaLoginHandler}>
                  <View
                    style={{
                      alignSelf: "center",
                      width: 40,
                  ...
                  >
                    <Image
                      ...
                      source={require("../../assets/images/UserLogin/insta.png")}
                    />
                  </View>
                </TouchableOpacity>
              </View>
              <View style={{ width: "100%", backgroundColor: "white" }}>
                ...
                >
                  Hopnob services are subject to our{" "}
                  <Text
                    style={{
                      fontFamily: "OpenSans",
                      textAlign: "center",
