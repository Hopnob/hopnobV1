...
const dislikesArray1 = [
    { id: '1',description:"Low Rise", image: require('../../../assets/images/styletest/dislikes/9.png') },
    { id: '2',description:"High Rise ", image: require('../../../assets/images/styletest/dislikes/10.png') },
    { id: '3',description:"Culottes", image: require('../../../assets/images/styletest/dislikes/11.png')},
    { id: '4',description:"Hotpants", image: require('../../../assets/images/styletest/dislikes/12.png') },
  ];  

export default function DislikesThreePage({navigation}){
    ...
    return(
        ...
        <View style={{width:'100%',marginBottom:280, backgroundColor:'white'}}>
          ...
          <TouchableOpacity onPress={()=> navigation.navigate('endStyleTestPage')}>
                    <Image width={60} source={require('../../../assets/images/check.png')} />
                </TouchableOpacity>
          </View>
        </View>
