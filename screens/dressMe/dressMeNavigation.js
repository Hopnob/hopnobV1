...
export default function DressMeNavigation({navigation}){
        ...
        <View style={{
          ...
          <LinearGradient colors={[ '#2D3791', '#4453DF']}
                      ...
                      <View style={{alignItems:'center'}} >
                          <Image width={30} height={34} source={require('../../assets/images/topNavBar/dressMe2.png')} />
                      <Text style={{fontWeight:'700',color:'white', fontFamily:'Open-sans', marginTop:5, fontSize:13,}}>Dress me</Text>
                      </View>
                      </TouchableOpacity>
          </LinearGradient>
          </Shadow>
