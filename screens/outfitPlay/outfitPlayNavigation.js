...
export default function OutfitPlayNavigation({navigation}){
      ...
      return(
        <View style={{
          ...
          <LinearGradient colors={['#FFFF', '#FFFF']}
                      ...
                      <View style={{alignItems:'center'}} >
                          <Image width={30} height={34} source={require('../../assets/images/topNavBar/camera.png')} />
                      <Text style={{fontWeight:'400',color:'black', fontFamily:'Open-sans', marginTop:5, fontSize:13,}}>Click & match</Text>
                      </View>
                      </TouchableOpacity>
          </LinearGradient>
          </Shadow>
          ...
          <LinearGradient colors={['#2D3791', '#4453DF']}
                      ...
                      <View style={{alignItems:'center'}} >
                          <Image width={30} height={34} source={require('../../assets/images/topNavBar/outfitPlay2.png')} />
                      <Text style={{fontWeight:'700',color:'white', fontFamily:'Open-sans', marginTop:5, fontSize:13,}}>Outfit Play</Text>
                      </View>
